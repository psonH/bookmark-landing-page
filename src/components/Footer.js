...
const Footer = () => {
  ...
  const checkEmail = (e) => {
    ...
    const validateEmail = validEmailRegex.test(e.target.value);
    if (!validateEmail) {
      setError(true);
    } else {
      setError(false);
  ...
  return (
    <div>
      <AttentionSeeker effect="rubberBand">
        <div className="main-footer d-flex flex-column justify-content-center align-items-center">
          <p className="footer-p">35,000+ Already Joined</p>
          <div className="footer-copy">
            Stay up-to-date with what we're doing
          </div>
          <div>
            <Form
              className="d-flex mt-4 justify-content-center footer-form"
      ...
      <div className="sub-footer">
        <div className="d-flex justify-content-center sub-footer-main">
